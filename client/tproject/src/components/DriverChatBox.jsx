...
function DriverChatBox({ socket, route, closed }) {
    ...
    const getMessages = () => {
        http.get(`/driver/chat/${route}/message`).then(res => {
    ...
    const sendFormik = useFormik({
        ...
        onSubmit: (values, { setSubmitting, resetForm }) => {
            setSendLoading(true)
            http.post(`/driver/chat/${route}/message`, { message: values.message }).then(res => {
